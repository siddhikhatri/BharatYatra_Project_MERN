...
//     axios
//       .post(`http://localhost:3000/uploadAvatar/${profile.email}`, formData, {
//         headers: { "Content-Type": "multipart/form-data" },
//       })
//       .then((res) => {
//         setProfile({ ...profile, avatar: res.data.filePath });
...
//                 <button
//                   type="submit"
//                   className="mt-6 bg-orange-500 text-white px-8 py-3 rounded-full hover:bg-orange-600"
//                 >
//                   Save
//                 </button>
//               </form>
